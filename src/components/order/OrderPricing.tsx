      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-flex items-center px-3 py-1 bg-accent-50 text-accent-500 text-xs font-medium rounded-full border border-accent-100">
            {t.orderPricing.badge}
          </span>
          <h2 className="mt-4 text-3xl sm:text-4xl lg:text-5xl font-display font-bold text-gray-900 tracking-tight">
            {t.orderPricing.title}
            <br />
            <span className="text-accent">{t.orderPricing.titleHighlight}</span>
          </h2>
          <p className="mt-4 text-gray-500 text-lg">{t.orderPricing.subtitle}</p>
        </motion.div>
          ...
          <div className="relative bg-white rounded-3xl border-2 border-accent/20 p-8 sm:p-10 shadow-xl shadow-accent/5">
            ...
            <div className="text-center pt-4">
              <div className="flex items-baseline justify-center gap-1">
                <span className="text-2xl font-semibold text-gray-400">{t.orderPricing.plan.currency}</span>
                <span className="text-6xl sm:text-7xl font-display font-extrabold text-gray-900 tracking-tight">{t.orderPricing.plan.price}</span>
                <span className="text-lg text-gray-400 font-medium">{t.orderPricing.plan.period}</span>
              </div>
              <p className="mt-2 text-gray-500">{t.orderPricing.plan.description}</p>
            </div>

            <div className="my-8 h-px bg-gray-100" />

            <ul className="space-y-4">
              {t.orderPricing.plan.features.map((feature, i) => (
            ...
            <div className="mt-8">
              ...
              >
                {t.orderPricing.plan.cta}
              </a>
              <p className="mt-3 text-center text-xs text-gray-400">{t.orderPricing.plan.trial}</p>
            </div>
          </div>
